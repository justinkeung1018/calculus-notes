...
% Usage: \upperint{lower bound}{upper bound}
...
\declaretheoremstyle[
    ...
    mdframed={
        linewidth=2pt,
        rightline=false, topline=false, bottomline=false,
        linecolor=NavyBlue!20, backgroundcolor=NavyBlue!2,
    }
]{thmlightbluebox}
...
\declaretheorem[numbered=no, style=thmlightbluebox, name=Solution]{solution}
\declaretheorem[numbered=no, style=thmlightbluebox, name=Intuition]{intuition}
